...
#ifndef CGAL_INTERSECTIONS_3_PLANE_3_POINT_3_H
...
CGAL_DO_INTERSECT_FUNCTION(Plane_3, Point_3, 3)
CGAL_INTERSECTION_FUNCTION(Plane_3, Point_3, 3)

} // namespace CGAL

#endif // CGAL_INTERSECTIONS_3_PLANE_3_POINT_3_H
