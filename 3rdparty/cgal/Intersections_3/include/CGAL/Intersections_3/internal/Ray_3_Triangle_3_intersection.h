...
//
// Note: This implementation is adapted from RAY_3_Triangle_3_do_intersect.h.
                               ...
                               const K& k)
{
  ...
  typename K::Construct_scaled_vector_3 sc = k.construct_scaled_vector_3_object();
  typename K::Compute_squared_length_3 sq_length = k.compute_squared_length_3_object();
  typename K::Construct_translated_point_3 trans = k.construct_translated_point_3_object();
             ...
             const K& k)
{
  ...
  typename K::Construct_ray_3 ray = k.construct_ray_3_object();
  typename K::Construct_point_on_3 point_on = k.construct_point_on_3_object();
