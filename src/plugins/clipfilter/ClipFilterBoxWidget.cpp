...
// Include local.
#define LOG_MODULE_NAME "ClipFilterBoxWidget"
#define LOG_MODULE_DEBUG_ENABLED 1
#include <Log.hpp>

ClipFilterBoxWidget::ClipFilterBoxWidget(MainWindow *mainWindow)
    : QWidget(mainWindow),
...
void ClipFilterBoxWidget::slotUpdate(void *sender,
...
void ClipFilterBoxWidget::setRegion(const Region &region)
{
...
void ClipFilterBoxWidget::filterChanged()
{
...
void ClipFilterBoxWidget::setFilterEnabled(bool b)
{
...
void ClipFilterBoxWidget::slotRangeIntermediateMinimumValue()
{
...
void ClipFilterBoxWidget::slotRangeIntermediateMaximumValue()
{
...
void ClipFilterBoxWidget::showEvent(QShowEvent *event)
{
    LOG_DEBUG_QT_EVENT(<< "Show event.");
    QWidget::showEvent(event);
}

void ClipFilterBoxWidget::hideEvent(QHideEvent *event)
{
