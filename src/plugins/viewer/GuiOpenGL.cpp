...
void GuiOpenGL::render(Mode mode,
...
void GuiOpenGL::renderClipFilter(const EditorFilterClip &clipFilter)
{
    ...
    GuiOpenGL::renderAabb(box);

    glDisable(GL_LINE_STIPPLE);
    glDepthMask(GL_TRUE);
}

void GuiOpenGL::renderAabb(const GuiAabb &box)
{
