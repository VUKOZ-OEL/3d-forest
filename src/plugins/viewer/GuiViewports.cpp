...
GuiViewports::GuiViewports(QWidget *parent) : QWidget(parent)
{
    initializeViewer();
}

GuiViewports::~GuiViewports()
{
}

void GuiViewports::initializeViewer()
{
    setLayout(ViewLayout::VIEW_LAYOUT_SINGLE);
}

GuiViewportOpenGL *GuiViewports::createViewport(size_t viewportId)
{
    GuiViewportOpenGL *viewport = new GuiViewportOpenGL(this);
...
GuiViewportOpenGL *GuiViewports::selectedViewport()
{
...
const GuiViewportOpenGL *GuiViewports::selectedViewport() const
{
    for (size_t i = 0; i < viewports_.size(); i++)
    {
        if (viewports_[i]->isSelected())
...
void GuiViewports::setViewOrthographic()
{
    selectedViewport()->setViewOrthographic();
}

void GuiViewports::setViewPerspective()
{
    selectedViewport()->setViewPerspective();
}

void GuiViewports::setViewTop()
{
    selectedViewport()->setViewTop();
}

void GuiViewports::setViewFront()
{
    selectedViewport()->setViewFront();
}

void GuiViewports::setViewRight()
{
    selectedViewport()->setViewRight();
}

void GuiViewports::setView3d()
{
    selectedViewport()->setView3d();
}

void GuiViewports::setViewResetDistance()
{
    selectedViewport()->setViewResetDistance();
}

void GuiViewports::setViewResetCenter()
{
    selectedViewport()->setViewResetCenter();
}

void GuiViewports::selectViewport(GuiViewportOpenGL *viewport)
{
    for (size_t i = 0; i < viewports_.size(); i++)
    {
...
size_t GuiViewports::selectedViewportId() const
{
    for (size_t i = 0; i < viewports_.size(); i++)
    {
        if (viewports_[i]->isSelected())
...
void GuiViewports::updateScene(Editor *editor)
{
    for (size_t i = 0; i < viewports_.size(); i++)
    {
...
void GuiViewports::resetScene(Editor *editor, bool resetView)
{
    for (size_t i = 0; i < viewports_.size(); i++)
    {
...
void GuiViewports::resetScene(Editor *editor, size_t viewportId, bool resetView)
{
...
EditorCamera GuiViewports::camera(size_t viewportId) const
{
    for (size_t i = 0; i < viewports_.size(); i++)
    {
...
void GuiViewports::setLayout(ViewLayout viewLayout)
{
    ...
    if (oldLayout)
    {
        ...
        GuiViewportOpenGL *viewport =
            dynamic_cast<GuiViewportOpenGL *>(item->widget());
        if (viewport)
        {
