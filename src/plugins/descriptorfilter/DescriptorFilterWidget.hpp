...
/** @file DescriptorFilterWidget.hpp */

#ifndef DESCRIPTOR_FILTER_WIDGET_HPP
#define DESCRIPTOR_FILTER_WIDGET_HPP
...
class DescriptorFilterWidget : public QWidget
{
    Q_OBJECT

public:
    DescriptorFilterWidget(MainWindow *mainWindow);
...
#endif /* DESCRIPTOR_FILTER_WIDGET_HPP */
