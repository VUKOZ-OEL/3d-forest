...
/** @file DescriptorFilterWidget.cpp */
...
// Include local.
#define LOG_MODULE_NAME "DescriptorFilterWidget"
#define LOG_MODULE_DEBUG_ENABLED 1
#include <Log.hpp>

DescriptorFilterWidget::DescriptorFilterWidget(MainWindow *mainWindow)
    : QWidget(mainWindow),
...
void DescriptorFilterWidget::slotUpdate(void *sender,
...
void DescriptorFilterWidget::setDescriptor(const Range<double> &range)
{
...
void DescriptorFilterWidget::filterChanged()
{
...
void DescriptorFilterWidget::setFilterEnabled(bool b)
{
...
void DescriptorFilterWidget::slotRangeIntermediateMinimumValue()
{
...
void DescriptorFilterWidget::slotRangeIntermediateMaximumValue()
{
