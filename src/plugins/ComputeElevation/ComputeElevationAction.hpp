...
/** @file ComputeElevationAction.hpp */

#ifndef COMPUTE_ELEVATION_ACTION_HPP
#define COMPUTE_ELEVATION_ACTION_HPP
...
/** Compute Elevation Action. */
class ComputeElevationAction : public ProgressActionInterface
{
public:
...
#endif /* COMPUTE_ELEVATION_ACTION_HPP */
