...
void ComputeSegmentationNNWidget::slotApply()
{
    ...
    parameters_.leafToWoodChannel =
        ComputeSegmentationNNParameters::CHANNEL_DESCRIPTOR;
    if (leafToWoodChannelRadioButton_
            [ComputeSegmentationNNParameters::CHANNEL_INTENSITY]
                ->isChecked())
    {
        parameters_.leafToWoodChannel =
...
void ComputeSegmentationNNWidget::slotHelp()
{
    ...
    t = "<h3>Automatic Segmentation NN Tool</h3>"
        ...
        "<br><br>"
        "<img src=':/ComputeSegmentationNNResources/segmentation.png'/>"
        ...
        "<br>"
        "<img src=':/ComputeSegmentationNNResources/segmentation-steps.png'/>"
        "<div>On the image:"
        ...
        "</ol>"
        "<br>"
        "<img src=':/ComputeSegmentationNNResources/segmentation-alg.png' />"
