...
/** @file FilterFilesPlugin.hpp */

#ifndef FILTER_FILES_PLUGIN_HPP
...
class FilterFilesWindow;
        ...
        #define EXPORT_FILTER_FILES_PLUGIN __declspec(dllexport)
    #else
        #define EXPORT_FILTER_FILES_PLUGIN __declspec(dllimport)
    #endif
#else
    #define EXPORT_FILTER_FILES_PLUGIN
#endif
