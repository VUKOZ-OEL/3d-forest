...
/** @file ComputeDescriptorPlugin.hpp */

#ifndef COMPUTE_DESCRIPTOR_PLUGIN_HPP
...
#if defined(_MSC_VER)
    #if defined(EXPORT_3DForestComputeDescriptorPlugin)
        #define EXPORT_COMPUTE_DESCRIPTOR_PLUGIN __declspec(dllexport)
    #else
        #define EXPORT_COMPUTE_DESCRIPTOR_PLUGIN __declspec(dllimport)
    #endif
#else
    #define EXPORT_COMPUTE_DESCRIPTOR_PLUGIN
#endif

/** Compute Descriptor Plugin. */
class ComputeDescriptorPlugin : public Plugin
{
public:
