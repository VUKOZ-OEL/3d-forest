...
/** @file ComputeDescriptorPca.hpp */

#ifndef COMPUTE_DESCRIPTOR_PCA_HPP
#define COMPUTE_DESCRIPTOR_PCA_HPP
...
/** Compute Descriptor PCA. */
class ComputeDescriptorPca
{
public:
...
#endif /* COMPUTE_DESCRIPTOR_PCA_HPP */
