...
/** @file GuiPluginImportDialog.cpp */
...
GuiPluginImportDialog::GuiPluginImportDialog(GuiWindowMain *window)
    : QDialog(window)
{
    // Widgets
...
void GuiPluginImportDialog::slotAccept()
{
    close();
    setResult(QDialog::Accepted);
}

void GuiPluginImportDialog::slotReject()
{
    close();
    setResult(QDialog::Rejected);
}

EditorSettingsImport GuiPluginImportDialog::getSettings() const
{
