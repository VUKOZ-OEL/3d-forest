...
public:
    ...
    void selectCamera(const EditorCamera &camera);
    ...
    void exec();
    void exec(const std::vector<FileLasIndex::Selection> &selectedPages);
    void reset();
    void clear();

    const std::vector<FileLasIndex::Selection> &selectedPages() const
    {
...
protected:
    ...
    std::vector<FileLasIndex::Selection> selectedPages_;
