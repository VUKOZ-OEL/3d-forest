...
FileLasIndexBuilder::FileLasIndexBuilder()
    : state_(STATE_NONE),
      valueTotal_(0),
      maximumTotal_(0)
{
...
std::string FileLasIndexBuilder::extension(const std::string &path)
{
    return File::replaceExtension(path, ".idx");
}

void FileLasIndexBuilder::index(const std::string &outputPath,
...
double FileLasIndexBuilder::percent() const
{
    if (maximumTotal_ == 0)
    {
        return 100.0;
...
void FileLasIndexBuilder::start(const std::string &outputPath,
                                const std::string &inputPath,
                                const FileLasIndexBuilder::Settings &settings)
{
    // Initialize
...
void FileLasIndexBuilder::openFiles()
{
    // Input
...
void FileLasIndexBuilder::nextState()
{
    value_ = 0;
    valueIdx_ = 0;
    maximum_ = 0;
...
void FileLasIndexBuilder::stateCopy()
{
    // Step
    uint64_t step;
    uint64_t remain;
...
void FileLasIndexBuilder::formatPoint(uint8_t *pout, const uint8_t *pin) const
{
...
void FileLasIndexBuilder::stateCopyPoints()
{
    // Step
    uint64_t step;
    uint64_t remainIdx;
...
void FileLasIndexBuilder::stateMove()
{
    // Move
    inputLas_.close();
    outputLas_.close();
...
void FileLasIndexBuilder::stateMainBegin()
{
...
void FileLasIndexBuilder::stateMainInsert()
{
    // Step
    uint64_t step;
    uint64_t remainIdx;
...
void FileLasIndexBuilder::stateMainEnd()
{
...
void FileLasIndexBuilder::stateMainSort()
{
    // Step
    uint64_t step;
    uint64_t remainIdx;
...
void FileLasIndexBuilder::stateNodeBegin()
{
}
...
void FileLasIndexBuilder::stateNodeInsert()
{
    // Step
    uint64_t step;
    FileLasIndex::Node *node;
...
void FileLasIndexBuilder::stateNodeEnd()
{
    indexFile_.seek(0);
    indexMain_.write(indexFile_);
...
void FileLasIndexBuilder::stateEnd()
{
