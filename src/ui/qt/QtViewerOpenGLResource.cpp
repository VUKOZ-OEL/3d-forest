...
/** @file QtViewerOpenGLResource.cpp */
...
// Include local.
#define LOG_MODULE_NAME "QtViewerOpenGLResource"
// #define LOG_MODULE_DEBUG_ENABLED 1
#include <Log.hpp>

size_t QtViewerOpenGLResource::nextConsumerId_ = 0;

QtViewerOpenGLResource::QtViewerOpenGLResource()
{
...
void QtViewerOpenGLResource::releaseGL(QtViewerOpenGLManager *managerGL)
{
...
bool QtViewerOpenGLResource::isInitialized(QtViewerOpenGLManager *managerGL)
{
...
void QtViewerOpenGLResource::registerGL(QtViewerOpenGLManager *managerGL)
{
...
void QtViewerOpenGLResource::initGL(QtViewerOpenGLManager *managerGL)
{
...
void QtViewerOpenGLResource::deregisterGL()
{
...
// Delete my resources.
void QtViewerOpenGLResource::deleteGL()
{
