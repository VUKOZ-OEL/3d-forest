...
/** @file QtViewerOpenGLStrokeFont.cpp */
...
// Include local.
#define LOG_MODULE_NAME "QtViewerOpenGLStrokeFont"
// #define LOG_MODULE_DEBUG_ENABLED 1
#include <Log.hpp>

QtViewerOpenGLStrokeFont::QtViewerOpenGLStrokeFont()
    : nChars_(128),
      charHeight_(0.5f)
{
    LOG_DEBUG(<< "Create.");
...
GLuint QtViewerOpenGLStrokeFont::list(QtViewerOpenGLManager *managerGL)
{
    ASSERT(managerGL);
...
float QtViewerOpenGLStrokeFont::textWidth(const std::string &text)
{
...
float QtViewerOpenGLStrokeFont::textHeight()
{
    return charHeight_;
}

// Update new geometry in OpenGL.
void QtViewerOpenGLStrokeFont::update()
{
    deleteGL();
}

// New build.
void QtViewerOpenGLStrokeFont::updateGL(QtViewerOpenGLManager *managerGL)
{
    LOG_DEBUG(<< "Update.");
    ASSERT(managerGL);
    ...
    displayList = managerGL->createResource(this,
                                            displayListId_,
                                            QtViewerOpenGLManager::DisplayList,
...
void QtViewerOpenGLStrokeFont::createStrokeFont(GLuint listId)
{
