...
/** @file QtViewerCamera.hpp */

#ifndef QT_VIEWER_CAMERA_HPP
#define QT_VIEWER_CAMERA_HPP
...
protected:
    ...
    friend void toJson(Json &out, const QtViewerCamera &in);
    friend std::string toString(const QtViewerCamera &in);
    friend std::ostream &operator<<(std::ostream &out,
                                    const QtViewerCamera &in);
};

inline void toJson(Json &out, const QtViewerCamera &in)
{
...
inline std::string toString(const QtViewerCamera &in)
{
    Json json;
    toJson(json, in);
...
inline std::ostream &operator<<(std::ostream &out, const QtViewerCamera &in)
{
    return out << toString(in);
}

#endif /* QT_VIEWER_CAMERA_HPP */
