...
/** @file QtViewerOpenGL.hpp */

#ifndef QT_VIEWER_OPENGL_HPP
#define QT_VIEWER_OPENGL_HPP
...
public:
    ...
    static void renderAabb(const QtViewerAabb &box);
    static void renderAabbCorners(const QtViewerAabb &box,
                                  float scale = 0.025F);
    ...
    static void renderText(QtViewerOpenGLManager *manager,
